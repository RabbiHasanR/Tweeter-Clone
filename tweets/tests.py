...
class TweetTestCase(TestCase):
    def setUp(self):
        self.user=User.objects.create_user(username='cef',password='somepassword')
        self.userb=User.objects.create_user(username='cef-2',password='somepassword2')
    ...
    def test_tweet_created(self):
        tweet_obj=Tweet.objects.create(content='my_tweet',user=self.user)
    ...
    def test_tweet_delete_api_view(self):
        ...
        response_inccorect_owner=client.delete('/api/tweets/3/delete')
        self.assertEqual(response_inccorect_owner.status_code,401)